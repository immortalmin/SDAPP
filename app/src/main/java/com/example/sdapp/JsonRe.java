...
public class JsonRe {
    ...
    public ArrayList<HashMap<String, Object>> ordersData(String jsonStr){
        ...
        try {
            ...
            for(int i=0;i<jsonArray.length();i++){
                ...
                JSONObject jsonObject = (JSONObject) jsonArray.opt(i);
                order.put("oid",jsonObject.getString("oid"));
                order.put("place_order_date",jsonObject.getString("place_order_date"));
                order.put("order_platform",jsonObject.getString("order_platform"));
                order.put("shopname",jsonObject.getString("shopname"));
                order.put("issue_platform",jsonObject.getString("issue_platform"));
                order.put("contact",jsonObject.getString("contact"));
                order.put("shopID",jsonObject.getString("shopID"));
                order.put("complimentary_items",jsonObject.getString("complimentary_items"));
                order.put("pattern",jsonObject.getString("pattern"));
                order.put("requirements",jsonObject.getString("requirements"));
                order.put("payment_amount",jsonObject.getString("payment_amount"));
                order.put("task_status",jsonObject.getString("task_status"));
                order.put("refund_way",jsonObject.getString("refund_way"));
                order.put("refund_date",jsonObject.getString("refund_date"));
                order.put("repurchase_span",jsonObject.getString("repurchase_span"));
                order.put("is_return_to_payaccount",jsonObject.getString("is_return_to_payaccount"));
                orders.add(order);
            }
        }catch (JSONException e) {
            e.printStackTrace();
    ...
    public HashMap<String, Object> orderData(String jsonStr){
        HashMap<String, Object> order = new HashMap<>();
        try {
            JSONArray jsonArray = new JSONArray(jsonStr);
            JSONObject jsonObject = (JSONObject) jsonArray.opt(0);
